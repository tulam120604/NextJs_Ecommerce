...
export const schemaValidateRegister = yup.object().shape({
  user_name: yup
    .string()
    .min(3, "Tên ít nhất 3 kí tự!")
    .max(30, "Tên không được phép vượt quá 30 kí tự!")
...
export const schemaValidateFormProduct = yup.object().shape({
  short_name: yup
    ...
    .min(3, "Tên sản phẩm phải chứa ít nhất 3 kí tự!")
    .max(255, "Tên sản phẩm tối đa 255 kí tự!"),
  des_product: yup
    .string()
    .required("Vui lòng nhập mô tả sản phẩm!")
    .min(6, "Mô tả sản phẩm phải chứa ít nhất 6 kí tự!")
    .max(5000, "Mô tả sản phẩm tối đa 5000 kí tự!"),
