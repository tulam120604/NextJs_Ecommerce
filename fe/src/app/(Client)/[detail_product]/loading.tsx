...
const LoadingDetail = () => {
  return (
    <main className="w-full *:max-w-[1440px] *:w-[342px] *:mx-auto *:h-full py-12">
      <div className="lg:grid lg:grid-cols-[573px_auto] auto-rows-[70vw] gap-x-20 *:bg-gray-200">
      ...
      {/* related products */}
      <Skeleton className="w-full h-[10vw] bg-gray-200"></Skeleton>
      <Skeleton className="pt-4 *:bg-gray-200">
