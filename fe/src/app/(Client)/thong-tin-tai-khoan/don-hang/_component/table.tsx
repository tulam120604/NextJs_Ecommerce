  ...
  return (
    <>
      {dataProps?.map((item: any) => (
          <div
            className="flex flex-col lg:flex-row gap-y-4 my-4 justify-between items-center border-t-2"
            key={item._id}>
            {/* 88 */}
            {/* image and name product */}
            <div className="flex lg:w-[700px] gap-x-4 *:max-h-[105px] items-center justify-between 
            lg:justify-normal w-full">
              <Link
                ...
                <Image
                  width={150}
                  height={150}
                  className="bg-[#f2f2f2f2] max-w-[90px] max-h-[90px]"
