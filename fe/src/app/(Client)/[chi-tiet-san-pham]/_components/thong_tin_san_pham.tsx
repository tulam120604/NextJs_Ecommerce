...
const Thong_tin_san_pham = ({ dataProps }: any) => {
  ...
  return (
    <div className="w-full *:w-full bg-gray-100 dark:bg-[#0F1629] lg:px-10 px-2 py-2 rounded-lg">
      <div className="flex flex-col gap-y-2 lg:gap-y-6">
        ...
        {/* different */}
        <span className="opacity-80 text-sm lg:text-base mt-4 lg:mt-0">Xuất xứ:&nbsp;{dataProps?.data?.made_in}</span>
      </div>
    </div>
  )
}
