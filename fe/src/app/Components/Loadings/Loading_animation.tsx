...
const Loading_animation = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width={40} height={40} className="shape-rendering: auto; display: block; background: rgb(255, 255, 255);" xmlnsXlink="http://www.w3.org/1999/xlink"><g><g transform="rotate(0 50 50)">
      <rect fill="#00c472" height={12} width={6} ry={6} rx={3} y={24} x={47}>
