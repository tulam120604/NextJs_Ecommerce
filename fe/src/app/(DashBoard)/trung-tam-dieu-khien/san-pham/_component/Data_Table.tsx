    ...
    <>
      ...
      {dataProps?.dataTable?.map((data: any) => {
        return (
          ...
          >
            <div
              className="grid grid-cols-[70px_180px_150px_100px_150px_100px_150px_auto] gap-x-4 
            ...
            >
              ...
              {/* sales */}
              <span className="line-clamp-2">
                {!data?.attributes && data?.sale_quantity}
              </span>
              {/* price */}
                ...
                {data?.variant &&
                  data?.variant?.variants?.map((item: any) =>
                    item?.value_variants?.map((value: any) => (
                      <div
                        key={item?._id}
                        className="grid border-t duration-200 border-gray-300 gap-x-4 grid-cols-[100px_180px_145px_100px_150px_100px_150px_80px] 
