...
import Search_Component from "@/app/Components/Form/search";
import { Suspense } from "react";
import LoadingPage from "@/app/Components/Loadings/LoadingPage";
import { Query_List_Items } from "@/app/_lib/Tanstack_Query/Items/query";

const page = () => {

  const { data } = Query_List_Items();

  return (
    <Suspense fallback={<LoadingPage />}>
      <div className="bg-[#101824] flex flex-col gap-y-6 py-6 rounded">
        <strong className="text-gray-200 lg:text-2xl">Tất cả sản phẩm</strong>
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-500 text-gray-200">
          <table className="w-full rounded bg-[#1F2936] text-sm">
            ...
            <tbody className="*:border-t *:border-gray-500">
              {data?.map((item : any) => {
                return (
                  <tr key={item.id} className="*:whitespace-nowrap *:px-4 *:py-2.5 *:font-medium">
                    ...
                    <td>
                      <div className="flex items-center gap-x-4 *:duration-300">
                        ...
                        <button className="hover:scale-110 ">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-file-pen-line"><path d="m18 5-2.414-2.414A2 2 0 0 0 14.172 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2" /><path d="M21.378 12.626a1 1 0 0 0-3.004-3.004l-4.01 4.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z" /><path d="M8 18h1" /></svg>
                        </button>
                        <button className="hover:scale-110 ">
