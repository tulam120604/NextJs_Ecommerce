...
import { Query_Category } from '@/app/_lib/Tanstack_Query/Items/query';
import React from 'react'

const Filter_Products = () => {
    // const { data , isPending} = Query_Category();
    ...
    return (
        <div>
            <div className="hidden lg:block w-full h-auto shadow-xl rounded-lg overflow-hidden">
                {/* categories */}
                <div className="pb-4">
                    <ul className="space-y-1">
                        <li>
                            <details className="group *:px-4  [&_summary::-webkit-details-marker]:hidden overflow-hidden hidden lg:block" open>
                                <summary className="flex cursor-pointer items-center justify-between bg-[#17AF26] py-2 text-white text-gray-900 hover:bg-[#669933] border">
                                    <strong className="mb:text-sm lg:text-base font-medium">Danh mục sản phẩm</strong>
                                                ...
                                                <li key={item._id} className="py-2">
                                                    <label htmlFor="Option5" className="w-full flex lg:justify-between items-center cursor-pointer items-start gap-4">
                                                        <div className="flex items-center *:lg:text-sm *:mb:text-xs">
                                                            ...
                                                            <strong className=" font-medium text-gray-900 mx-3"> {item.category_name} </strong>
                                                        </div>
                                                        <span className='text-xs text-gray-400'>( {item.products.length} )</span>
                                                    </label>
                                                </li>
                                            )
                                        })
                ...
                <div className="pt-2 pb-4">
                    <ul className="space-y-1">
                        <li>
                            <details className="group [&_summary::-webkit-details-marker]:hidden hidden *:px-4 lg:block" open>
                                <summary className="flex cursor-pointer text-white bg-[#17AF26] hover:bg-[#669933] items-center justify-between py-2">
