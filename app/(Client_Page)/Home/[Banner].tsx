      ...
      <div className="lg:w-[1440px] mb:w-[342px] md:w-[95vw] md:h-[720px] mb:h-[694px] justify-between">
        ...
        <div className="flex flex-col *:flex *:flex-col md:pl-16 md:py-[120px] mb:py-[57px]">
          ...
          <div className="flex flex-col *:text-white lg:mt-[105px] mb:mt-[39px]">
            <div className="flex items-center gap-x-6 *:lg:text-2xl *:mb:text-lg mb:tracking-[0.2px] lg:tracking-0">
              <span>Giảm 25%</span>
              |
              <span>Miễn phí vận chuyển</span>
            </div>
            <Link className="bg-[#17AF26] lg:mt-11 mb:mt-6 lg:text-lg lg:w-[185px] mb:w-[145px] grid place-items-center lg:h-[64px] mb:h-[56px] rounded-[100px] border-none hover:scale-110 duration-300" href="">Xem chi tiết</Link>
          </div>
        </div>
      </div>
    </div>
