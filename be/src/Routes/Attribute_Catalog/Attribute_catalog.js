...
import { update_attribute_catalog } from '../../Controllers/Attribute_catalog/update.js';
...
Routes_Attribute.patch('/attribute_catalog/update/:key', update_attribute_catalog);
